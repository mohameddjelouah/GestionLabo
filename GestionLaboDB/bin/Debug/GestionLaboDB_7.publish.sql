...
GO
PRINT N'Creating [dbo].[spGetAllMaladesAnalyses]...';


GO
CREATE PROCEDURE [dbo].[spGetAllMaladesAnalyses]


AS
begin
	set nocount on;
	SELECT ma.*, an.* from dbo.Malades ma left join dbo.Analyse an on ma.Id = an.MaladeID; 
end
GO
