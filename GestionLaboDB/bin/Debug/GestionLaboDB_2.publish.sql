...
GO
/*
The column [dbo].[Malades].[AnalyseID] is being dropped, data loss could occur.
*/

IF EXISTS (select top 1 1 from [dbo].[Malades])
    RAISERROR (N'Rows were detected. The schema update is terminating because data loss might occur.', 16, 127) WITH NOWAIT

GO
PRINT N'Altering [dbo].[Malades]...';


GO
ALTER TABLE [dbo].[Malades] DROP COLUMN [AnalyseID];
