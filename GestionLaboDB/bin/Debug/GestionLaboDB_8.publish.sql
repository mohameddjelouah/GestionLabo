...
GO
PRINT N'Altering [dbo].[spGetAllMaladesAnalyses]...';


GO
ALTER PROCEDURE [dbo].[spGetAllMaladesAnalyses]


AS
begin
	set nocount on;
	SELECT ma.*, an.* from dbo.Analyse ma left join dbo.Malades an on ma.MaladeID = an.Id; 
end
GO
PRINT N'Creating [dbo].[spDeleteAnalyse]...';
...
GO
PRINT N'Creating [dbo].[spDeleteMalade]...';
